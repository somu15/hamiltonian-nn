...
import os, sys
THIS_DIR = os.path.dirname(os.path.abspath('/Users/dhulls/projects/Small Pf/hamiltonian-nn/2D_pdf')) # __file__
PARENT_DIR = os.path.dirname(os.path.dirname(os.path.abspath('/Users/dhulls/projects/Small Pf/hamiltonian-nn/2D_pdf'))) # __file__
