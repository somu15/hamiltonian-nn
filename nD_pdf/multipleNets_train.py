...
def get_args():
    ...
    parser.add_argument('--hidden_dim', default=500, type=int, help='hidden dimension of mlp') # 100
    ...
    parser.add_argument('--learn_rate', default=1e-4, type=float, help='learning rate') # 5e-4
    parser.add_argument('--batch_size', default=1000, type=int, help='batch_size') # 1000
    ...
    parser.add_argument('--total_steps', default=25000, type=int, help='number of gradient steps') # 100000
...
def get_model(args, baseline):
    ...
    path = "100D_Gaussian_1.tar" # .format(args.save_dir, RK4, model_name) # ndpdf-hnn 
...
#   nn_model = MLP(args.input_dim, args.hidden_dim, output_dim, args.nonlinearity)
  model = get_model(args, baseline=False)
